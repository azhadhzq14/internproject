...
Route::prefix('/panel')->middleware(['authlogin'])->name('admin.')->group(function () {
    ...
    Route::get('/prasekolah',[ModuleLearningController::class,'prasekolah'])->name("prasekolah");
    Route::get('/sekren',[ModuleLearningController::class,'sekren'])->name("sekren");
    Route::get('/sekmen',[ModuleLearningController::class,'sekmen'])->name("sekmen");
